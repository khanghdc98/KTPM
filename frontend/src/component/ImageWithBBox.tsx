...
export const ImageWithBBox: React.FC<ImageWithBBoxProps> = ({ image, detections, colorMap, chosenToken, setChosenToken }) => {
    ...
    return (
        <Box height="100%" position="relative" width="fit-content">
            {image !== undefined ?
                (<Box component="img" src={image} height="100%" sx={{ objectFit: "contain" }} />)
                :
                (
