...
export const ImageWithBBoxWrapper: React.FC<ImageWithBBoxWrapperProps> = ({ timestamp, detections, colorMap, chosenToken, setChosenToken }) => {
    ...
    return (
        <ImageWithBBox image={frame} detections={detections} colorMap={colorMap} chosenToken={chosenToken} setChosenToken={setChosenToken} />
    )
